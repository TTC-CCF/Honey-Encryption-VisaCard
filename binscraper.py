...
if __name__ == '__main__':
    src = getSource("https://stevemorse.org/ssn/List_of_Bank_Identification_Numbers.html")
    f = open('prefix_lengths.txt', 'r')
    g = getPrefixProbability(addLengths(matchStrings(src), eval(f.read())))
    print (analyze(g))
    removeRepetitions(g)
    writeFile('bin.txt', remove(g))
